 ...
 * {@link PscBackendMetadataClientCreator} that are returned by this class, ordered by the plugin priority (ascending) within
...
public class PscMetadataClientCreatorManager {
    ...
    private static int getPriority(PscBackendMetadataClientCreator creator) {
        ...
        if (annotation == null) {
            logger.warn("Creator missing PscMetadataClientCreatorPlugin annotation; defaulting priority to Integer.MAX_VALUE: "
