...
public class TestPscMetadataClientCreatorManager {
    ...
    void testCreatorsWithSameBackendAreSortedByPriority() {
        ...
        Map<String, List<PscBackendMetadataClientCreator>> backendCreators = manager.getBackendCreators();
        ...
        assertEquals(PriorityTenTestMetadataClientCreator.class, testCreators.get(0).getClass());
        assertEquals(PriorityOneTestMetadataClientCreator.class, testCreators.get(1).getClass());
    }
