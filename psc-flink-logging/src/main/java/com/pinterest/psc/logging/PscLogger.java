...
import com.pinterest.psc.logging.slf4j.PscSlf4jLogger;
...
public interface PscLogger {
    ...
    static PscLogger getLogger() {
        switch (PscLoggerManager.pscLoggerType) {
            case SLF4J:
                return PscSlf4jLogger.getLogger();
            case LOG4J:
            case LOG4J2:
            case LOGBACK:
    ...
    static PscLogger getLogger(String name) {
        switch (PscLoggerManager.pscLoggerType) {
            case SLF4J:
                return PscSlf4jLogger.getLogger(name);
            case LOG4J:
            case LOG4J2:
            case LOGBACK:
                throw new UnsupportedOperationException(
    ...
    static PscLogger getLogger(Class clazz) {
        switch (PscLoggerManager.pscLoggerType) {
            case SLF4J:
                return PscSlf4jLogger.getLogger(clazz);
            case LOG4J:
            case LOG4J2:
            case LOGBACK:
                throw new UnsupportedOperationException(
