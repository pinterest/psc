// TODO: kafka junit5 3.2.3 does not support multi-cluster setup
...
//            topicUriPrefixes[i] = String.format("plaintext:" + TopicUri.SEPARATOR + TopicUri.STANDARD +
//            ":kafka:env:cloud_region%d::cluster%d:", i, i);
...
//        pscConfiguration.setProperty("psc.discovery.security.protocols", String.join(",", Collections.nCopies
//        (sharedKafkaTestResources.length, "plaintext")));
//
...
//
//        for (PscConsumerCreator pscConsumerCreator : pscConsumerCreators) {
//            Map<String, String> connectionStringByTopicUriString = pscConsumerCreator
//            .getConnectionStringByTopicUriString();
...
//    }
//
//    private Map<String, TopicUriInfo> generateRandomTopicUriInfos(int numberOfTopics, int maxClusters) throws
//    Exception {
