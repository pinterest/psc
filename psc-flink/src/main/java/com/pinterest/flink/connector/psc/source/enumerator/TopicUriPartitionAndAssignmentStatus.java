...
@Internal
public class TopicUriPartitionAndAssignmentStatus {
    private final TopicUriPartition topicUriPartition;
    private final AssignmentStatus assignmentStatus;

    public TopicUriPartitionAndAssignmentStatus(
            TopicUriPartition topicUriPartition, AssignmentStatus assignStatus) {
        this.topicUriPartition = topicUriPartition;
        this.assignmentStatus = assignStatus;
    }

    public TopicUriPartition topicUriPartition() {
