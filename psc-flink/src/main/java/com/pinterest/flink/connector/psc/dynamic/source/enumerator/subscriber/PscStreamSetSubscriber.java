...
@Internal
public class PscStreamSetSubscriber implements PscStreamSubscriber {

    private final Set<String> streamIds;

    public PscStreamSetSubscriber(Set<String> streamIds) {
        this.streamIds = streamIds;
    }

    @Override
    public Set<PscStream> getSubscribedStreams(PscMetadataService pscMetadataService) {
        return new HashSet<>(pscMetadataService.describeStreams(streamIds).values());
    }
}
