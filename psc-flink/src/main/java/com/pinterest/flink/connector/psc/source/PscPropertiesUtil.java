...
@Internal
public class PscPropertiesUtil {

    private PscPropertiesUtil() {}
     ...
     */
    public static void setClientIdPrefix(Properties properties, String clusterId) {
