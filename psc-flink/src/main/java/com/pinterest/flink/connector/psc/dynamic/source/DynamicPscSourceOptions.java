...
/**
 * The connector options for {@link DynamicPscSource} that can be passed through the source
 * properties e.g. {@link DynamicPscSourceBuilder#setProperties(Properties)}.
 */
@Internal
public class DynamicPscSourceOptions {

    private DynamicPscSourceOptions() {}
