...
public class PscRecordSerializationSchemaBuilder<IN> {
     ...
     * @return {@code this}
     */
    public <T extends IN> PscRecordSerializationSchemaBuilder<T> setKeySerializationSchema(
     ...
     * @return {@code this}
     */
    public <T extends IN> PscRecordSerializationSchemaBuilder<T> setValueSerializationSchema(
