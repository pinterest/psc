 ...
 */
@Internal
public class PscClusterMetricGroup implements SourceReaderMetricGroup {

    public static final String DYNAMIC_PSC_SOURCE_METRIC_GROUP = "DynamicPscSource";
    public static final String PSC_CLUSTER_GROUP_NAME = "pscCluster";
