...
public interface PscRecordDeserializationSchema<T> extends Serializable, ResultTypeQueryable<T> {
    ...
    static <V> PscRecordDeserializationSchema<V> of(
        ...
        return new org.apache.flink.connector.kafka.source.reader.deserializer.KafkaDeserializationSchemaWrapper<>(kafkaDeserializationSchema);
    }
    ...
    static <V> PscRecordDeserializationSchema<V> valueOnly(
        ...
        return new org.apache.flink.connector.kafka.source.reader.deserializer.KafkaValueOnlyDeserializationSchemaWrapper<>(valueDeserializationSchema);
    }
    ...
    static <V, D extends Deserializer<V>> PscRecordDeserializationSchema<V> valueOnly(
        ...
        return new org.apache.flink.connector.kafka.source.reader.deserializer.KafkaValueOnlyDeserializerWrapper<>(valueDeserializerClass, config);
    }
}
