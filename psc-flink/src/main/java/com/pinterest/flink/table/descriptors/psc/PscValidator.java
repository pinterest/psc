...
public class PscValidator extends ConnectorDescriptorValidator {
    ...
    public static final String CONNECTOR_TYPE_VALUE_PSC = "psc";
    ...
    public static final String CONNECTOR_PROPERTIES_GROUP_ID = "connector.properties." + PscConfiguration.PSC_CONSUMER_GROUP_ID;
    ...
    public void validate(DescriptorProperties properties) {
        ...
        properties.validateValue(CONNECTOR_TYPE, CONNECTOR_TYPE_VALUE_PSC, false);

        properties.validateString(CONNECTOR_TOPIC, false, 1, Integer.MAX_VALUE);

        validateStartupMode(properties);

        validatePscProperties(properties);
    ...
    private void validatePscProperties(DescriptorProperties properties) {
    ...
    public static boolean hasConcisePscConfiguration(DescriptorProperties descriptorProperties) {
        return descriptorProperties.containsKey(CONNECTOR_PROPERTIES_GROUP_ID);
    }
}
