...
/**
 * A partitioner ensuring that each internal Flink partition ends up in one PSC partition.
 *
 * <p>Note, one Kafka partition can contain multiple Flink partitions.
 *
 * <p>Cases:
 * # More Flink partitions than PSC partitions
 * <pre>
 * 		Flink Sinks:		PSC Partitions
 * 			1	----------------&gt;	1
 * 			2   --------------/
 * 			3   -------------/
 * 			4	------------/
 * </pre>
 * Some (or all) PSC partitions contain the output of more than one flink partition
 *
 * <p>Fewer Flink partitions than PSC
 * <pre>
 ...
 * </pre>
 *
 * <p>Not all PSC topic URI partitions contain data
 ...
 */
@PublicEvolving
public class FlinkFixedPartitioner<T> extends FlinkPscPartitioner<T> {
