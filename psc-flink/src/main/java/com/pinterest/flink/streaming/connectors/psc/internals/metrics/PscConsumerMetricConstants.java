...
/**
 * A collection of PSC consumer metrics related constant strings.
 *
 * <p>The names must not be changed, as that would break backward compatibility for the consumer's metrics.
 */
@Internal
public class PscConsumerMetricConstants {

    public static final String PSC_CONSUMER_METRICS_GROUP = "PscConsumer";
