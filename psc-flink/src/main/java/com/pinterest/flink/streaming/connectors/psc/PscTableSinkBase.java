...
public abstract class PscTableSinkBase implements AppendStreamTableSink<Row> {
     ...
     */
    protected final Optional<FlinkPscPartitioner<Row>> partitioner;

    protected PscTableSinkBase(
            TableSchema schema,
            String topicUri,
        ...
        this.topicUri = Preconditions.checkNotNull(topicUri, "Topic URI must not be null.");
     ...
     */
    protected abstract SinkFunction<Row> createPscProducer(
            String topic,
            Properties properties,
            SerializationSchema<Row> serializationSchema,
            Optional<FlinkPscPartitioner<Row>> partitioner);
    ...
    public DataStreamSink<?> consumeDataStream(DataStream<Row> dataStream) {
        final SinkFunction<Row> pscProducer = createPscProducer(
                topicUri,
                properties,
                serializationSchema,
                partitioner);
    ...
    @Override
    public PscTableSinkBase configure(String[] fieldNames, TypeInformation<?>[] fieldTypes) {
    ...
    public boolean equals(Object o) {
        ...
        final PscTableSinkBase that = (PscTableSinkBase) o;
