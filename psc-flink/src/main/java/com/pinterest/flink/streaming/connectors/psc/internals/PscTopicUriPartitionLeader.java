 ...
 */
@Internal
public class PscTopicUriPartitionLeader implements Serializable {
    ...
    public PscTopicUriPartitionLeader(PscTopicUriPartition pscTopicUriPartition, Node leader) {
        ...
        this.cachedHash = 31 * cachedHash + pscTopicUriPartition.hashCode();
    }

    public PscTopicUriPartition getPscTopicUriPartition() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PscTopicUriPartitionLeader)) {
            return false;
        }

        PscTopicUriPartitionLeader that = (PscTopicUriPartitionLeader) o;

        if (!pscTopicUriPartition.equals(that.pscTopicUriPartition)) {
            return false;
        }
    ...
    public String toString() {
        return "PscTopicUriPartitionLeader{" +
                "leaderId=" + leaderId +
                ", leaderPort=" + leaderPort +
                ", leaderHost='" + leaderHost + '\'' +
                ", topicUri=" + pscTopicUriPartition.getTopicUriStr() +
                ", partition=" + pscTopicUriPartition.getPartition() +
                '}';
    }
