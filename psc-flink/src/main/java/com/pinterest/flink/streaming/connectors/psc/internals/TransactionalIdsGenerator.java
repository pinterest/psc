...
/**
 * Class responsible for generating transactional ids to use when communicating with PSC.
 *
...
public class TransactionalIdsGenerator {
    ...
    public TransactionalIdsGenerator(
        ...
        // PSC configuration assumes ',' to be a splitter of configuration values. Replace with ';'.
     ...
     * [nextFreeTransactionalId, nextFreeTransactionalId + parallelism * pscProducersPoolSize)
