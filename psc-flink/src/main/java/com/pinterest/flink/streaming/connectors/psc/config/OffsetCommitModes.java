...
public class OffsetCommitModes {
     ...
     *
     * @param enableAutoCommit         whether or not auto committing is enabled in the provided PSC properties.
    ...
    public static OffsetCommitMode fromConfiguration(
        ...
        if (enableCheckpointing) {
            ...
            // else, the mode depends only on whether auto committing is enabled in the provided PSC properties
            return (enableAutoCommit) ? OffsetCommitMode.BACKEND_PUBSUB_PERIODIC : OffsetCommitMode.DISABLED;
        }
    }
}
