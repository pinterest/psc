...
/**
 * Startup modes for the PSC Consumer.
 */
@Internal
public enum StartupMode {

    /**
     * Start from committed offsets of a specific consumer group (default).
     */
    GROUP_OFFSETS(PscTopicUriPartitionStateSentinel.GROUP_OFFSET),

    /**
     * Start from the earliest offset possible.
     */
    EARLIEST(PscTopicUriPartitionStateSentinel.EARLIEST_OFFSET),

    /**
     * Start from the latest offset.
     */
    LATEST(PscTopicUriPartitionStateSentinel.LATEST_OFFSET),
