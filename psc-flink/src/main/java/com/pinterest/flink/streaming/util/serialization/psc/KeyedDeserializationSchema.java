 ...
 * @deprecated Use {@link PscDeserializationSchema}.
 */
@Deprecated
@PublicEvolving
public interface KeyedDeserializationSchema<T> extends PscDeserializationSchema<T> {
    /**
    ...
    @Override
    default T deserialize(PscConsumerMessage<byte[], byte[]> record) throws IOException {
        return deserialize(
                record.getKey(),
                record.getValue(),
