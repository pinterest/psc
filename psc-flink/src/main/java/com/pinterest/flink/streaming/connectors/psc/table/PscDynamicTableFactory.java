 ...
 */
@Internal
public class PscDynamicTableFactory
        implements DynamicTableSourceFactory, DynamicTableSinkFactory {

    private static final Logger LOG = LoggerFactory.getLogger(PscDynamicTableFactory.class);
...
//        options.add(PROPS_BOOTSTRAP_SERVERS);
    ...
    public DynamicTableSource createDynamicTableSource(Context context) {
        ...
        final boolean enableRescale = tableOptions.get(SCAN_ENABLE_RESCALE);
        ...
        return createPscTableSource(
                ...
                getSourceTopicUriPattern(tableOptions),
                properties,
    ...
    public DynamicTableSink createDynamicTableSink(Context context) {
        ...
        return creatPscTableSink(
                ...
                getFlinkPscPartitioner(tableOptions, context.getClassLoader()).orElse(null),
                deliveryGuarantee,
                parallelism,
    ...
    protected PscDynamicSource createPscTableSource(
    ...
    protected PscDynamicSink creatPscTableSink(
            ...
            String topic,
            Properties properties,
            FlinkPscPartitioner<RowData> partitioner,
