 ...
 *
 * <p>Problem is that FlinkPscProducer (universal) and FlinkKafkaProducer011 have different names and
 ...
 * for example FlinkKafkaProducer011.KafkaTransactionState and FlinkPscProducer.KafkaTransactionState
 ...
 * FlinkPscProducer.*Serializer counter parts. After all serialized binary data are exactly
...
public class FlinkPscProducer011 {
    ...
    public static class NextTransactionalIdHint extends FlinkPscProducer.NextTransactionalIdHint {
    }
}
