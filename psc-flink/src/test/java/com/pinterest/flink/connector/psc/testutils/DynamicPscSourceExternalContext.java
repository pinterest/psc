...
import com.pinterest.flink.connector.psc.dynamic.source.DynamicPscSourceBuilder;
...
/** A external context for {@link DynamicPscSource} connector testing framework. */
public class DynamicPscSourceExternalContext implements DataStreamSourceExternalContext<String> {
    private static final Logger logger =
            LoggerFactory.getLogger(DynamicPscSourceExternalContext.class);
    ...
    private final Set<PscStream> pscStreams = new HashSet<>();
    ...
    public Source<String, ?, ?> createSource(TestingSourceSettings sourceSettings)
        ...
        final DynamicPscSourceBuilder<String> builder = DynamicPscSource.builder();
    ...
    public void close() throws Exception {
        ...
        for (Map.Entry<String, List<String>> entry : clusterTopics.entrySet()) {
            ...
            // TODO: use PscMetadataClient after deleteTopics is implemented
