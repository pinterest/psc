...
//                            .setBootstrapServers(PscSourceTestEnv.brokerConnectionStrings)
        ...
        public void testPerPartitionWatermark() throws Throwable {
            String watermarkTopic = PscTestEnvironmentWithKafkaAsPubSub.PSC_TEST_CLUSTER1_URI_PREFIX + "watermarkTestTopic-" + UUID.randomUUID();
        ...
        public void testConsumingEmptyTopic() throws Throwable {
            String emptyTopic = PscTestEnvironmentWithKafkaAsPubSub.PSC_TEST_CLUSTER1_URI_PREFIX + "emptyTopic-" + UUID.randomUUID();
        ...
        public void testConsumingTopicWithEmptyPartitions() throws Throwable {
            String topicWithEmptyPartitions = PscTestEnvironmentWithKafkaAsPubSub.PSC_TEST_CLUSTER1_URI_PREFIX + "topicWithEmptyPartitions-" + UUID.randomUUID();
