...
/**
 * Tests for the {@link PscValidator}.
 */
public class PscValidatorTest {
    ...
    public void testValidateTimestampStartupMode() {
        ...
        try {
            new PscValidator().validate(descriptorProperties1);
        } catch (Exception e) {
        ...
        try {
            new PscValidator().validate(descriptorProperties3);
        } catch (Exception e) {
            Optional<Throwable> throwable =
