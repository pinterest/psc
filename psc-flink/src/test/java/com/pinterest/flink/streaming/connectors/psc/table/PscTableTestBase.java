...
public abstract class PscTableTestBase extends PscTestBaseWithFlinkWithKafkaAsPubSub {
...
//                        .useBlinkPlanner()
    ...
    public void testPscSourceSink() throws Exception {
        ...
        // ---------- Produce an event time stream -------------------
        String groupId = standardPscConsumerConfiguration.getProperty(PscConfiguration.PSC_CONSUMER_GROUP_ID);
        ...
        if (!isLegacyConnector) {
            ...
            createTable = String.format(
                    "create table psc (\n" +
                            ...
                            "  'connector.properties.psc.consumer.group.id' = '%s',\n" +
        ...
        String initialValues = "INSERT INTO psc\n" +
        ...
        try {
            ...
            // because the registered PSC source is infinite.
