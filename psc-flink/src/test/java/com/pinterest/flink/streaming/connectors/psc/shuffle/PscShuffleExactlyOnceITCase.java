 ...
 */
public class PscShuffleExactlyOnceITCase extends PscShuffleTestBase {
    ...
    private void testKafkaShuffleFailureRecovery(
        ...
        createKafkaShuffle(
                env, topicUri, numElementsPerProducer, producerParallelism, timeCharacteristic, numberOfPartitions)
