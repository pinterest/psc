...
/**
 * The base for the PSC tests with Flink's MiniCluster and Kafka as backend pubsub.
 */
@SuppressWarnings("serial")
public abstract class PscTestBaseWithFlinkWithKafkaAsPubSub extends PscTestBaseWithKafkaAsPubSub {
